          ...
          <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="Date" disabled value="<?php echo date("Y/m/d"); ?>">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="inputEmail4">Time</label>
                        <input type="text" class="form-control" name="Time" disabled value="<?php echo date("h:i:sa"); ?>">
                    </div>
